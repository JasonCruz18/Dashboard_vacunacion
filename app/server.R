...
shinyServer(function(input, output) {
  ...
  output$grafico_gore <- renderHighchart({
  ...
  output$grafico_essalud <- renderHighchart({
...
#+++++++++++++++++++++++++++---
  ...
  output$grafico2_1chumbivilcas <- renderHighchart({
  ...
  output$grafico2_2chumbivilcas <- renderHighchart({
  ...
  output$grafico2_1kimbiri <- renderHighchart({
  ...
  output$grafico2_2kimbiri <- renderHighchart({
